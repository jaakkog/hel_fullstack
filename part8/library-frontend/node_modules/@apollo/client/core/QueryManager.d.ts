...
export declare class QueryManager<TStore> {
    ...
    private setNetStatus;
    queryListenerForObserver<T>(queryId: string, observer: Observer<ApolloQueryResult<T>>): QueryListener;
    ...
    observeQuery<T>(observableQuery: ObservableQuery<T>, observer: Observer<ApolloQueryResult<T>>): Promise<FetchResult<T, Record<string, any>, Record<string, any>>>;
    ...
    startPollingQuery(options: WatchQueryOptions, queryId: string): string;
